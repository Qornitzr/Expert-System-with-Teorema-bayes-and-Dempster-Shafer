...
public class DempsterShaferFragment extends Fragment {
...
//            System.out.println("Max Final "+ namaPenyakit +" - "+hasilPersen+" %");
            ...
            HasilDiagnosaActivity hasilActivity = (HasilDiagnosaActivity) getActivity();
            hasilActivity.data(namaPenyakit, presentase);
...
//            System.out.println("Max Final "+ namaPenyakit +" - "+hasilPersen+" %");
            ...
            cursor1 = db.rawQuery("SELECT r.probabilitas_mb, g.nama_gejala, g.penyakit_terpilih from rule r inner join penyakit p on r.id_pen = p.id_penyakit inner join gejala g on r.id_gej = g.id_gejala where g.nama_gejala in (" + getActivity().getIntent().getStringExtra("namagejala") + ") group by g.nama_gejala order by g.id_gejala ASC", null, null);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_dempster_shafer, container, false);
